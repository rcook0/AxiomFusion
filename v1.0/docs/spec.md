...
## 13. IR optimization + compilation targets (v0.8)

v0.8 introduces an optimizer over IR and a first-class target system (Pine indicator/strategy, MQL5 EA, Python runtime). See `docs/targets.md` and `docs/optimizer.md`.


## 14. Debuggability and traceability (v0.9)

Adds stable node IDs, source spans, compiler source maps, and runtime tracing (binding/signal values + intent decisions). See `docs/debug.md`.
