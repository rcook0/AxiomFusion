...
from .semantics import infer_required_semantics, validate_semantics
...
def validate_source_for_target(src: str, target_name: str, *, opt: str="O2", strict: bool=True, allow_caps: Optional[Set[str]]=None) -> ValidationResult:
    ...
    code = rep.emitted
    errors = []
# v1.5 semantic contracts
req_sem = infer_required_semantics(src)
sem_errs = validate_semantics(req_sem, getattr(contract, "semantics", {}) or {})
for code, msg in sem_errs:
